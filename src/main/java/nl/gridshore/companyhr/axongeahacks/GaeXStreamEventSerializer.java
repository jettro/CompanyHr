 ...
 */
public class GaeXStreamEventSerializer implements EventSerializer {

    private GaeGenericXStreamSerializer genericXStreamSerializer;
     ...
     * encoding.
     */
    public GaeXStreamEventSerializer() {
     ...
     */
    public GaeXStreamEventSerializer(String charsetName) {
     ...
     */
    public GaeXStreamEventSerializer(Charset charset) {
        this.charset = charset;
        genericXStreamSerializer = new GaeGenericXStreamSerializer(charset);
